...
bassenc_module = system.load_dll('bassenc')
...
BASS_Encode_Start = func_type(HENCODE, ctypes.c_ulong, ctypes.c_wchar_p, ctypes.c_ulong, ENCODEPROC, ctypes.c_void_p)(('BASS_Encode_Start', bassenc_module))
