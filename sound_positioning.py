...
def position_sound_3d(handle,  listener_x,  listener_y,  listener_z,  source_x,  source_y,  source_z,  pan_step=0.0,  volume_step=0.0,  pitch_step=1.0,  behind_pitch_decrease=0.0,  behind_volume_decrease=3.0, pitch_range=1.0,  start_pan=0.0,  start_volume=100.0,  start_pitch=100.0):
 position_sound_custom_3d(handle, listener_x, listener_y, listener_z, source_x, source_y, source_z, pan_step, volume_step, pitch_step, behind_pitch_decrease, behind_volume_decrease, pitch_range, start_pan, start_volume, start_pitch)

def position_sound_custom_3d(handle,  listener_x,  listener_y,  listener_z,  source_x,  source_y,  source_z,  pan_step,  volume_step,  pitch_step,  behind_pitch_decrease,  behind_volume_decrease, pitch_range,  start_pan,  start_volume,  start_pitch):
 delta_x=0
 delta_y=0
 delta_z=0
 final_pan=start_pan
